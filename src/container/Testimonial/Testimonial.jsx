...
const Testimonial = () => {
  ...
  return (
    ...
    <h2 className="head-text">
        Student <span>Feedback</span> on UrbanPro
      </h2>
      {testimonials.length && (
        <>
        
        <div className="app__testimonial-item bg-white shadow-lg rounded-lg p-6 relative">
  <svg className="absolute top-2 right-2 w-32 h-auto text-cyan-500" width="347" height="188" viewBox="0 0 347 188" fill="none" xmlns="http://www.w3.org/2000/svg">
