...
<div className='flex mt-5 gap-x-2 text-xs md:text-sm justify-center text-gray-600 divide-x-2'>
  ...
  <div className="grid">
          ...
          {/* <div className='tag-cmp app__flex'>
            ...
            <p className="p-text">Tutor</p>
          </div> */}
        </div>
        {/* <div className="max-w-lg mx-auto p-6 bg-white rounded-lg shadow-xl transition-shadow hover:shadow-2xl">
  <div className="badge-cmp app__flex mb-10">
    <div className="text-center space-y-4">
      <p className="inline-block bg-purple-100 text-purple-700 rounded-full px-3 py-1 text-sm font-medium">
        Batch Announcement
      </p>
      <p className="text-gray-800 text-lg">
        Join my 30-day live C programming session! Just one hour a day, no cost at all!
      </p>

      <div className="flex items-center justify-center gap-4 mt-4">

        <div className="text-gray-800 uppercase p-3 text-center">
          <p className="text-md">First Batch Starts</p>
          <p className="text-lg font-semibold text-blue-600">22-OCT-2024</p>
        </div>
      </div>

      <div className="flex justify-around text-sm text-gray-600 mt-4">
        <p>Seats: 300</p>
        <p>Time: 07:30 - 08:30pm</p>
        <p>Mode: Online</p>
      </div>

      <div className="text-center">
        <button className="mt-6 py-3 px-6 bg-blue-600 text-white text-md font-medium rounded-lg shadow-md hover:bg-blue-700 transition-all focus:outline-none focus:ring-2 focus:ring-blue-500">
          Sign Up
        </button>
      </div>
    </div>
      ...
      >
        {[images.c, images.javascript, images.react, images.redux].map((circle, index) => 
