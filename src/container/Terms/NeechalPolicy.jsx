...
const NeechalPolicy = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-8 bg-white  ">
      ...
      <p className="mb-4">
        To exercise these rights, please contact us at <a href="mailto:support@neechal.com" className="text-blue-800 underline">support@neechal.com</a>
      </p>
      ...
      <p className="mb-4">
        If you have any questions or concerns about this Privacy Policy or our data practices, please contact us at: <a href="mailto:support@neechal.com" className="text-blue-800 underline">support@neechal.com</a>
      </p>
    </div>
  );
};

export default NeechalPolicy;
