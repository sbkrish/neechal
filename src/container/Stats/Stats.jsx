...
<div className="flex justify-center gap-4 p-5 pb-3 flex-wrap">
  <div className="flex justify-start flex-col border rounded-lg p-3 w-40 sm:w-48">
    <p className="font-bold text-xl sm:text-2xl">8+</p>
    <p className="text-sm sm:text-lg text-gray-700">Years Tutoring</p>
  </div>
  <div className="flex justify-start flex-col border rounded-lg p-3 w-40 sm:w-48">
    <p className="font-bold text-xl sm:text-2xl">400+</p>
    <p className="text-sm sm:text-lg text-gray-700">Students</p>
  </div>
  <div className="flex justify-start flex-col border rounded-lg p-3 w-40 sm:w-48">
