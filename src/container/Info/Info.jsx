    ...
    <footer className="bg-gray-900">
      <div className="mx-auto max-w-5xl pt-16 pb-5 sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-400 px-4">
          Empowering students and professionals with expert programming
          knowledge through interactive learning. Dive into the world of coding
          and swim across all levels with us.
        </p>
        {path === "/" ? (
        ...
        >
          ...
          <Link
            href="/"
            className="flex justify-center max-w-xs mx-auto  mt-10 bg-blue-600 text-white py-2 px-6 rounded-lg hover:bg-blue-700 transition"
          >
            Go Back Home
          </Link>
        )}
        ...
        <ul className="mt-12 flex justify-center gap-6 md:gap-8">
          <li>
            <a
              href="https://www.instagram.com/neechaltech"
              rel="noreferrer"
              target="_blank"
              className="transition text-white hover:text-white/75"
            >
          ...
          <li>
            <a
              href="https://www.linkedin.com/company/neechal"
              rel="noreferrer"
              target="_blank"
              className="transition text-white hover:text-white/75"
            >
          ...
          <li>
            <a
              href="https://www.youtube.com/@neechal"
              rel="noreferrer"
              target="_blank"
              className="transition text-white hover:text-white/75"
            >
          ...
          <li>
            <a
              href="https://www.facebook.com/neechaltech"
              rel="noreferrer"
              target="_blank"
              className="transition text-white hover:text-white/75"
            >
        ...
        <div className="mt-16 border-t pt-5 border-gray-800 flex flex-col-reverse sm:flex-row justify-between gap-2 sm:gap-0 items-center text-sm text-gray-400">
          <p className="text-center sm:text-left">
            © Neechal 2024. All rights reserved.
          </p>
